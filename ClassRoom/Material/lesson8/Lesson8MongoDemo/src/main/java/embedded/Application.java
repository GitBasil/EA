...
import embedded.domain.Address;
import embedded.domain.CreditCard;
import embedded.domain.Customer;
import embedded.repository.CustomerRepository;
...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		customer.addCreditCard(creditCard2);
		address = new Address("1000 n 4th street", "Farfield", "52556");
		customer.setAddress(address);
		customerRepository.save(customer);
		customerRepository.save(customer);
